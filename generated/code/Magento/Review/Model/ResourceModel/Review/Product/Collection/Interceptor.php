...
class Interceptor extends \Magento\Review\Model\ResourceModel\Review\Product\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addStoreFilter($storeId = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addStoreFilter', func_get_args(), $pluginInfo) : parent::addStoreFilter($storeId);
    }
    ...
    public function addEntityFilter($entityId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addEntityFilter', func_get_args(), $pluginInfo) : parent::addEntityFilter($entityId);
    }
    ...
    public function setDateOrder($dir = 'DESC')
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setDateOrder', func_get_args(), $pluginInfo) : parent::setDateOrder($dir);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addReviewSummary');
        return $pluginInfo ? $this->___callPlugins('addReviewSummary', func_get_args(), $pluginInfo) : parent::addReviewSummary();
    }
    ...
    public function addRateVotes()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addRateVotes', func_get_args(), $pluginInfo) : parent::addRateVotes();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getResultingIds');
        return $pluginInfo ? $this->___callPlugins('getResultingIds', func_get_args(), $pluginInfo) : parent::getResultingIds();
    }
