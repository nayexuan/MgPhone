...
class Interceptor extends \Magento\Newsletter\Model\ResourceModel\Queue\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addTemplateInfo');
        return $pluginInfo ? $this->___callPlugins('addTemplateInfo', func_get_args(), $pluginInfo) : parent::addTemplateInfo();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSubscribersInfo');
        return $pluginInfo ? $this->___callPlugins('addSubscribersInfo', func_get_args(), $pluginInfo) : parent::addSubscribersInfo();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSubscriberFilter');
        return $pluginInfo ? $this->___callPlugins('addSubscriberFilter', func_get_args(), $pluginInfo) : parent::addSubscriberFilter($subscriberId);
    }

    /**
     * {@inheritdoc}
     */
    public function addCustomerFilter(int $customerId): \Magento\Newsletter\Model\ResourceModel\Queue\Collection
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCustomerFilter');
        return $pluginInfo ? $this->___callPlugins('addCustomerFilter', func_get_args(), $pluginInfo) : parent::addCustomerFilter($customerId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addOnlyForSendingFilter');
        return $pluginInfo ? $this->___callPlugins('addOnlyForSendingFilter', func_get_args(), $pluginInfo) : parent::addOnlyForSendingFilter();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addOnlyUnsentFilter');
        return $pluginInfo ? $this->___callPlugins('addOnlyUnsentFilter', func_get_args(), $pluginInfo) : parent::addOnlyUnsentFilter();
    }
    ...
    public function addStoreFilter($storeIds)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addStoreFilter', func_get_args(), $pluginInfo) : parent::addStoreFilter($storeIds);
    }
