...
class Interceptor extends \Magento\Backend\Block\Widget\Grid\Massaction\Item\Additional\DefaultAdditional implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'createFromConfiguration');
        return $pluginInfo ? $this->___callPlugins('createFromConfiguration', func_get_args(), $pluginInfo) : parent::createFromConfiguration($configuration);
    }
