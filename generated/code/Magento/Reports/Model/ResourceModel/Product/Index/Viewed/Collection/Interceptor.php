...
class Interceptor extends \Magento\Reports\Model\ResourceModel\Product\Index\Viewed\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addIndexFilter()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addIndexFilter', func_get_args(), $pluginInfo) : parent::addIndexFilter();
    }
    ...
    public function addFilterByIds($ids)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addFilterByIds', func_get_args(), $pluginInfo) : parent::addFilterByIds($ids);
    }
    ...
    public function setAddedAtOrder($dir = 'DESC')
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setAddedAtOrder', func_get_args(), $pluginInfo) : parent::setAddedAtOrder($dir);
    }
    ...
    public function excludeProductIds($productIds)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('excludeProductIds', func_get_args(), $pluginInfo) : parent::excludeProductIds($productIds);
    }
